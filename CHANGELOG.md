...
- 扩展参数处理器以支持pytest fixture动态检测和集成
- 新增 _is_fixture() 方法识别fixture函数标志
- 改进参数解析逻辑，区分fixture参数化和常规参数化
- 增强堆叠 @parametrize_test 装饰器的多参数处理机制
- 优化fixture参数值动态获取和注入流程
- 完善错误处理和回退机制

### 测试变更

- 更新集成测试文档和规范，明确测试用例标记和格式
- 新增原生 pytest 测试用例
