...
###### 2.1.3.1.1 测试函数参数化装饰器 (parametrize_test.py)
...
###### 2.1.3.1.3 生成器参数化装饰器 (parametrize_generator.py)
...
| 接口名称 | 描述 | 参数 | 返回值 |
|---------|------|------|--------|
| `parametrize_test` | 测试函数参数化装饰器 | argnames: str, argvalues: list, **kwargs | 装饰器函数 |
| `parametrize_fixture` | fixture 参数化装饰器 | argnames: str, argvalues: list, **kwargs | 装饰器函数 |
| `parametrize_generator` | 生成器参数化装饰器 | argnames: str, argvalues: list, **kwargs | 装饰器函数 |
| `param_generator` | 参数生成器装饰器 | func: callable, scope: str, cache: bool, lazy: bool | 装饰器函数 |
| `DynRef` | 参数引用类 | name: str | DynRef 实例 |

#### 2.3.2 内部接口

| 接口名称 | 描述 | 参数 | 返回值 |
|---------|------|------|--------|
| `DependencyResolver.resolve` | 解析依赖 | dependencies: dict, context: dict | dict |
...
| `DynRef.resolve` | 解析引用的参数值 | context: dict | Any |
