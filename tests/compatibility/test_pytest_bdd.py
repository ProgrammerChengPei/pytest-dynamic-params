...
@parametrize_test("x, y, expected", [[1, 2, 3], [3, 4, 7], [5, 6, 11]])
...
class TestBddWithDynRef:
    """Test pytest-bdd with DynRef functionality."""
    
    def test_bdd_dynref(self, isolated_test_env, run_pytest_cmd):
        """Test BDD with DynRef."""
...
@parametrize_test("multiplier, expected", [[2, 4], [3, 6], [4, 8]])
...
@parametrize_test("value", generate_cached_bdd_data)
...
@parametrize_test("value", generate_lazy_bdd_data)
...
@parametrize_test("base", generate_bdd_values)
...
@parametrize_test("input_val, expected", [[1, 2], [2, 4], [3, 6]])
