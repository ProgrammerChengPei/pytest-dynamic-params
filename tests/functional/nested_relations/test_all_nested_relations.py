...
class TestStaticParamCallsDynamicParam:
    """测试静态参数调用动态参数"""
...
class TestStaticParamCallsStaticFixture:
    """测试静态参数调用静态fixture"""
...
class TestStaticParamCallsDynamicFixture:
    """测试静态参数调用动态fixture"""
...
class TestStaticFixtureCallsStaticParam:
    """测试静态fixture调用静态参数"""
...
class TestStaticFixtureCallsDynamicParam:
    """测试静态fixture调用动态参数"""
...
class TestDynamicFixtureCallsDynamicParam:
    """测试动态fixture调用动态参数"""
