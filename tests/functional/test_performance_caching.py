...
class TestCachingBasic:
    ...
    def test_cached_generation(self):
        ...
        @parametrize_test("num", generate_cached_numbers)
        def test_num(num):
    ...
    def test_session_caching(self):
        ...
        @parametrize_test("data", generate_session_cached)
        def test_data(data):
...
class TestCachingScope:
    ...
    def test_function_scope_cache(self):
        ...
        @parametrize_test("timestamp1", generate_function_cached)
        @parametrize_test("timestamp2", generate_function_cached)
    ...
    def test_module_scope_cache(self):
        ...
        @parametrize_test("data", generate_module_cached)
        def test_data(data):
...
class TestLazyLoading:
    ...
    def test_lazy_with_caching(self):
        ...
        @parametrize_test("data", generate_lazy_cached)
        def test_data(data):
...
class TestPerformanceOptimization:
    ...
    def test_expensive_computation_cached(self):
        ...
        @parametrize_test("result", generate_expensive_computation)
    ...
    def test_optimized_generation(self):
        ...
        @parametrize_test("data", generate_optimized_data)
        def test_data(data):
            assert len(data) == 50
...
class TestMemoryEfficiency:
    ...
    def test_large_dataset_caching(self):
        ...
        @parametrize_test("data", generate_large_dataset)
        def test_data(data):
    ...
    def test_nested_structure_caching(self):
        ...
        @parametrize_test("nested", generate_nested_structure)
