...
def test_use_generators_calls_static_fixture():
    """测试 use_generators 调用静态fixture"""
...
def test_use_generators_calls_dynamic_fixture():
    """测试 use_generators 调用动态fixture"""
...
def test_static_fixture_calls_use_generators():
    """测试静态fixture调用 use_generators"""
...
# 14. 动态fixture调用动态参数
@generator
def dynamic_generator(input_value):
    """生成动态参数"""
...
def test_dynamic_fixture_calls_use_generators():
    """测试动态fixture调用 use_generators"""
