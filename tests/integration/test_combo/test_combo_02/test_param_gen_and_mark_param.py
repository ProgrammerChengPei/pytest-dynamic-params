"""
parametrize_generator + pytest.mark.parametrize 组合测试

测试 parametrize_generator 装饰器与 pytest.mark.parametrize 的组合使用
...
# ============== 示例 02：@parametrize_generator 与 pytest.mark.parametrize 混用 ==============
...
@pytest.mark.uncollected(reason="@parametrize_generator 与 pytest.mark.parametrize 混用会失败")
@pytest.mark.parametrize("num", gen_numbers)
...
@pytest.mark.parametrize("text", gen_strings)
...
@pytest.mark.parametrize("a, b", gen_pairs)
