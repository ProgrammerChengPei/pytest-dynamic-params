...
class TestParametrizeProcessor:
    ...
    def test_resolve_parameters_with_dynref(self):
        """Test resolve_parameters with DynRef"""
        processor = ParametrizeProcessor()
        parametrization = {
            "argnames": "a,b",
            "argvalues": [10, DynRef("a")]
        }
        context = {"a": 10}
    ...
    def test_resolve_parameters_with_expression(self):
        """Test resolve_parameters with DynRef expression"""
        processor = ParametrizeProcessor()
        parametrization = {
            "argnames": "a,b,sum",
            "argvalues": [10, 20, DynRef("a") + DynRef("b")]
        }
        context = {"a": 10, "b": 20}
    ...
    def test_resolve_value_with_dynref(self):
        ...
        result = processor._resolve_value(DynRef("a"), context)
    ...
    def test_resolve_value_with_list(self):
        ...
        result = processor._resolve_value([1, DynRef("a"), 3], context)
    ...
    def test_resolve_value_with_dict(self):
        ...
        result = processor._resolve_value({"x": DynRef("a"), "y": 5}, context)
    ...
    def test_resolve_value_with_tuple(self):
        ...
        result = processor._resolve_value((DynRef("a"), 2), context)
