...
class TestParamGenerator:
    ...
    def test_function_style_with_multiple_args(self):
        ...
        decorated_func = param_generator(scope="class", cache=False, lazy=False)(sample_func)
...
class TestWithDynamicParams:
    ...
    def test_decorator(self):
        ...
        assert decorated_func._dynamic_param_mapping['dynamic_param'] == sample_generator
    ...
    def test_multiple_params(self):
        ...
        decorated_func = with_dynamic_params(param1=generator1, param2=generator2)(test_func)
