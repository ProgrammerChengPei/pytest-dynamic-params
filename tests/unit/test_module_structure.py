...
class TestModuleExports:
    ...
    def test_main_module_exports(self):
        ...
        assert hasattr(dynamic_params, "parametrize_test")
        assert hasattr(dynamic_params, "parametrize_fixture")
        assert hasattr(dynamic_params, "parametrize_generator")
        assert hasattr(dynamic_params, "param_generator")
        assert hasattr(dynamic_params, "DynRef")
    ...
    def test_config_module_import(self):
        ...
        from dynamic_params import config
